...
const pathways = [
  {
    ...
    bullets: ["TFSA, RRSP & FHSA optimization", "Beginner-friendly ETFs & index funds", "Dividend portfolios that pay monthly", "Cash value life insurance", "Insured Retirement strategies"],
  ...
  },
  {
    ...
    bullets: ["Part-time business in financial services", "Digital products & online stores", "Plug-and-play templates & suppliers", "Systems to run in 5–10 hrs/week"],
